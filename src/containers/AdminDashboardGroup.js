const AdminDashboardGroup = ({ className = "", title, children }) => {
  return (
    <>
      <div
        className={`${className} relative flex w-full items-center justify-center gap-3 border-2 border-dashed rounded-2xl border-accent-1-dark border-opacity-60 p-6 pb-4`}>
