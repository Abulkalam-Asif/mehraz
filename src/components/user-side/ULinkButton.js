...
const ULinkButton = ({
  ...
  const colorStyles = {
    ...
    gold: "relative z-[1] bg-gradient-to-b from-accent-gold-lighter to-accent-gold-light shadow-btn before:bg-white before:opacity-0 before:z-[-1] before:absolute before:top-0.5 before:left-0.5 before:right-0.5 before:bottom-0.5 before:rounded-sm hover:text-accent-gold hover:from-accent-gold hover:to-accent-gold hover:before:opacity-100 hover:shadow-none before:transition-opacity before:duration-300 duration-300",
