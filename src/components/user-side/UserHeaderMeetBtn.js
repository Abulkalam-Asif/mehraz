      ...
      <div className="relative flex items-center justify-center">
        ...
        <div
          className={`bg-white rounded-lg shadow-dropdown-2 absolute top-12 grid transition-grid-rows-opacity-padding duration-300 ${
            isDropdownOpen
              ? "grid-rows-[1fr] px-6 py-2 opacity-100"
              : "grid-rows-[0fr] p-0 opacity-0"
          }`}>
          <div
            className={`overflow-hidden uppercase w-max flex flex-col gap-2`}>
            <Link href="/" className="inline-flex items-center gap-8 py-2">
