    ...
    <>
      <div className="flex flex-col space-y-1">
        ...
        <div className="relative">
          ...
          {expanded && (
            <div
              className="w-max absolute bottom-0 translate-y-full right-0 bg-white shadow-2xl rounded-md border-2 border-accent-1-base px-4 py-2 grid grid-cols-2 gap-x-3 gap-y-2 z-10"
              ref={dropdownRef}>
